...
%This value is determined based on T2 in the prostate.
%Dinh, A. Hoang, et al. "Characterization of prostate cancer using T2 mapping at 3 T: a multi-scanner study." Diagnostic and interventional imaging 96.4 (2015): 365-372.

%T1 dependency
dphis = [1 2 4];
alpha = 20*(pi/180);

T1s = [300:50:2000]*1e-3;
T2 = 50e-3;
D = 2000*1e-12;
...
figure;
plot(T1s*1000, Phase_D1(:,1)*(180/pi),'LineWidth',2);axis square; hold on;
plot(T1s*1000, Phase_D1(:,2)*(180/pi),'LineWidth',2);axis square; 
plot(T1s*1000, Phase_D1(:,3)*(180/pi),'LineWidth',2);axis square; 
legend({'\theta = 1\circ', '\theta = 2\circ', '\theta = 4\circ', '\theta = 6\circ'}); legend('boxoff');
xlabel('T1 (ms)'); ylabel('Signal Phase (\circ)');title('Moment = 2\pi');ylim([0 50]);xlim([300 2000]);
set(gca, 'fontname', 'Arial', 'FontSize',18,'FontWeight','bold','LineWidth',2);
set(gcf,'units','inches','position',[0,0,5,5])


figure;
plot(T1s*1000, Phase_D2(:,1)*(180/pi),'LineWidth',2);axis square; hold on;
plot(T1s*1000, Phase_D2(:,2)*(180/pi),'LineWidth',2);axis square; 
plot(T1s*1000, Phase_D2(:,3)*(180/pi),'LineWidth',2);axis square; 
legend({'\theta = 1\circ', '\theta = 2\circ', '\theta = 4\circ', '\theta = 6\circ'}); legend('boxoff');
xlabel('T1 (ms)'); ylabel('Signal Phase (\circ)');title('Moment = 8\pi');ylim([0 50]);xlim([300 2000]);
set(gca, 'fontname', 'Arial', 'FontSize',18,'FontWeight','bold','LineWidth',2);
set(gcf,'units','inches','position',[0,0,5,5])
...
Phase_D1 = zeros(length(T2s),length(Ds));
Phase_D2 = zeros(length(T2s),length(Ds));
G1 = 4.6367e+05;
G2 = 4.3054e+06;
...
figure;
plot(T2s*1000, Phase_D1(:,1)*(180/pi),'LineWidth',2);hold on;
plot(T2s*1000, Phase_D1(:,2)*(180/pi),'LineWidth',2);
plot(T2s*1000, Phase_D1(:,3)*(180/pi),'LineWidth',2);
plot(T2s*1000, Phase_D1(:,4)*(180/pi),'LineWidth',2);
legend({'ADC = 0', 'ADC = 500', 'ADC = 1000', 'ADC = 2000 (\mu mm^2/s)'});legend('boxoff');
xlabel('T2 (ms)'); ylabel('Signal Phase (\circ)');title('Moment = 2\pi');ylim([0 50]);
set(gca, 'fontname', 'Arial', 'FontSize',18,'FontWeight','bold','LineWidth',2);
set(gcf,'units','inches','position',[0,0,5,5])

figure;
plot(T2s*1000, Phase_D2(:,1)*(180/pi),'LineWidth',2);hold on;
plot(T2s*1000, Phase_D2(:,2)*(180/pi),'LineWidth',2);
plot(T2s*1000, Phase_D2(:,3)*(180/pi),'LineWidth',2);
plot(T2s*1000, Phase_D2(:,4)*(180/pi),'LineWidth',2);
legend({'ADC = 0', 'ADC = 500', 'ADC = 1000', 'ADC = 2000 (\mu mm^2/s)'});legend('boxoff');
...
figure;
plot(Ds*1e+12, Phase_D1(:,1)*(180/pi),'LineWidth',2);hold on;
plot(Ds*1e+12, Phase_D1(:,2)*(180/pi),'LineWidth',2);
plot(Ds*1e+12, Phase_D1(:,3)*(180/pi),'LineWidth',2);
legend({'\theta = 1\circ', '\theta = 2\circ', '\theta = 4\circ', '\theta = 6\circ'});legend('boxoff');
xlabel('ADC (\mu mm^2/s)'); ylabel('Signal Phase (\circ)');title('Moment = 2\pi');ylim([0 50]);xlim([100 2000]);
set(gca, 'fontname', 'Arial', 'FontSize',18,'FontWeight','bold','LineWidth',2);
set(gcf,'units','inches','position',[0,0,5,5])


figure;
plot(Ds*1e+12, Phase_D2(:,1)*(180/pi),'LineWidth',2);hold on;
plot(Ds*1e+12, Phase_D2(:,2)*(180/pi),'LineWidth',2);
plot(Ds*1e+12, Phase_D2(:,3)*(180/pi),'LineWidth',2);
legend({'\theta = 1\circ', '\theta = 2\circ', '\theta = 4\circ', '\theta = 6\circ'});legend('boxoff');
xlabel('ADC (\mu mm^2/s)'); ylabel('Signal Phase (\circ)');title('Moment = 8\pi');ylim([0 50]);xlim([100 2000]);
set(gca, 'fontname', 'Arial', 'FontSize',18,'FontWeight','bold','LineWidth',2);
set(gcf,'units','inches','position',[0,0,5,5])
...
figure;
plot(FAs, Phase_D1(:,1)*(180/pi),'LineWidth',2);hold on;
plot(FAs, Phase_D1(:,2)*(180/pi),'LineWidth',2);
plot(FAs, Phase_D1(:,3)*(180/pi),'LineWidth',2);
legend({'\theta = 1\circ', '\theta = 2\circ', '\theta = 4\circ', '\theta = 6\circ'}); legend('boxoff');
xlabel('FA (\circ)'); ylabel('Signal Phase (\circ)');title('Moment = 2\pi');ylim([0 50]);xlim([0 40]);
set(gca, 'fontname', 'Arial', 'FontSize',18,'FontWeight','bold','LineWidth',2);
set(gcf,'units','inches','position',[0,0,5,5])


figure;
plot(FAs, Phase_D2(:,1)*(180/pi),'LineWidth',2);hold on;
plot(FAs, Phase_D2(:,2)*(180/pi),'LineWidth',2);
plot(FAs, Phase_D2(:,3)*(180/pi),'LineWidth',2);
legend({'\theta = 1\circ', '\theta = 2\circ', '\theta = 4\circ', '\theta = 6\circ'}); legend('boxoff');
xlabel('FA (\circ)'); ylabel('Signal Phase (\circ)');title('Moment = 8\pi');ylim([0 50]);xlim([0 40]);
set(gca, 'fontname', 'Arial', 'FontSize',18,'FontWeight','bold','LineWidth',2);
set(gcf,'units','inches','position',[0,0,5,5])
