...
Phase_T2D = zeros(length(Ds),length(T2s),length(FAs));
Phase_D1 = zeros(length(Ds),length(T2s),length(FAs));
Phase_D2 = zeros(length(Ds),length(T2s),length(FAs));
Abs_D1 = zeros(length(Ds),length(T2s),length(FAs));
Abs_D2 = zeros(length(Ds),length(T2s),length(FAs));
